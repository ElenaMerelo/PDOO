...
public class MainWindow_v2 extends JFrame implements View {
    ...
    private String appName = "Tutorial GUI 1.0 con otra estética";
    ...
    public void updateView() {
        boolean canSpend = (controller.getAppState() == AppState.PERSONCANSPEND);
        if (!canSpend)
            jcSpendChecks.setSelected (false);
        jcSpendChecks.setEnabled(canSpend);
        personView.setPerson(controller.getModelToUI().getCurrent(), jcSpendChecks.isSelected());
    }
