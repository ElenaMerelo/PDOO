...
class CardDealer {
    ...
    public String to_string(){
        return suppliesPackages + " suppliesPackages" + shieldBoosters + " shieldBoosters" +
    weapons + " weapons" + hangars + " hangars" + enemies + " enemies";
    }
    ...
    private void createSuppliesPackages() {
        ...
        suppliesPackages.add(new SuppliesPackage(0.0f, 0.0f, 0.0f));
    }
    private void createWeapons() {
       ...
       weapons.add(new Weapon("La caña de España", WeaponType.PLASMA, 3));   
    }
    ...
    private void createShieldBoosters() {
       ...
       shieldBoosters.add(new ShieldBooster("Ghostbooster", 0.0f, 3));
    }
    ...
    private void createEnemies() {
        ...
        Loot my_loot= new Loot(2, 3, 2, 1, 0);
        ...
        Damage my_numeric_damage= new Damage(3, 2);
        ...
        Damage my_specific_damage= new Damage(new ArrayList(Arrays.asList(WeaponType.LASER, 
                                                                            WeaponType.LASER, 
                                                                            WeaponType.LASER, 
                                                                            WeaponType.MISSILE, 
                                                                            WeaponType.MISSILE,
